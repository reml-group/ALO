...
class GQAEval:
    def __init__(self, result_eval_file, ques_file_path, choices_path=None, EVAL_CONSISTENCY=False,
                 EVAL_HEAD_TAIL=False):
        ##### Files Loading
        ##########################################################################################
        ...
        self.predictions = {p["question_id"]: p["answer"] for p in self.predictions}
